...
class WarzoneTournoisResultatsQuadTypePart3 extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('userKills3', NumberType::class, [
                ...
                'required' => true,
                'mapped' => true,
                'label' => "Kills joueur 3",
                'constraints' => [new Regex(['pattern' => '#^[0-9]#'])]
            ])

            ->add('userKills4', NumberType::class, [
                'attr' => ['autocomplete' => 'chrome-off'],
                'required' => true,
                'mapped' => true,
                'label' => "Kills joueur 4",
                'constraints' => [new Regex(['pattern' => '#^[0-9]#'])]
            ])
